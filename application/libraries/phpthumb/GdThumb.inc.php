<?php
/**
 * PhpThumbLatest GD Thumb Class Definition File
 * 
 * This file contains the definition for the GdThumb object
 * 
 * PHP Version 5 with GD 2.0+
 * PhpThumbLatest : PHP Thumb Library <http://phpthumb.gxdlabs.com>
...
class GdThumb extends ThumbBase
{
	 ...
	 * @return GdThumb
	 */
	public function adaptiveResize ($width, $height, $doRounded=false)
	{
		// make sure our arguments are valid
		...
		/**/
		if($doRounded){
			$this->imageRoundedCopyResampled($this->workingImage,$this->oldImage,0,0,$cropX,$cropY,$cropWidth,$cropHeight,$cropWidth,$cropHeight,10);
		} else {
			imagecopyresampled
			(
				$this->workingImage,
	 ...
	 * ----------------------------------------------------------- */
	public function imageRoundedCopyResampled(&$dstimg, &$srcimg, $dstx, $dsty, $srcx,
