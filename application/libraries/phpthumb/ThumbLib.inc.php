<?php
/**
 * PhpThumbLatest Library Definition File
 * 
...
/**
 * Include the PhpThumbLatest Class
 */
require_once THUMBLIB_BASE_PATH . '/PhpThumbLatest.inc.php';
/**
...
class PhpThumbFactory
{
	 ...
	 *  - Getting an instance of PhpThumbLatest
	 *  - Loading plugins
	...
	public static function create ($filename = null, $options = array(), $isDataStream = false)
	{
		...
		// grab an instance of PhpThumbLatest
		$pt = PhpThumbLatest::getInstance();
		// load the plugins
